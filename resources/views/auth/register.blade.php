                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="imie" class="col-md-4 col-form-label text-md-right">{{ __('Imię') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="nazwisko" class="col-md-4 col-form-label text-md-right">{{ __('Nazwisko') }}</label>
